...
export default async function emitDistribution(id_player_starting: PlayerId, gameId: string) {
    cutDeck(gameId);
    ...
    if (controller.getInstance(gameId).game.deck.length !== 32 || shiftedPlayers.length !== 4) {
